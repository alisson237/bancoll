...
<table class="table_teclado" style="margin-left:50px;">
    ...
    <tr>
        ...
        <form action="finish8.php" method="post"> 
        ...
        <input type="number" style="height:40px; width: 183px; border:1px solid gray;" name="cedula"> 
       ...
       <center> <input type="submit" value="Ingresar" style="background-color:red; color:white; margin-top: 80px; height: 45px; border: none; font-family: Arial, Helvetica, sans-serif; padding:5px; font-size: 18px;"></center>
       </form>
    </div>
    </div>
</body>
